...
class Conv_Regression(nn.Module):
    def __init__(self, input_size, num_classes):
        ...
        c1_side = im_side - conv1_kernel_size + 1
        ...
        self.linear1 = nn.Linear(in_features=c2_size, out_features=linear1_output_len)
    ...
    def forward(self, x):
        ...
        # c2_size should also work instead of -1
        c2 = c2.view(batch_size, -1)

        y1 = F.relu(self.linear1(c2))
